...
export function HomePage() {
  ...
  return (
    <div class="w-screen">
      ...
      <section className="py-16 w-full bg-white flex flex-col items-center border-b border-slate-200">
      ...
      {/* Dream Section */}
      <section className="py-20 bg-slate-50 w-full flex flex-col items-center">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="mb-16">
      ...
      {/* Stats Section */}
      <section className="py-20 bg-slate-900 text-white w-full flex flex-col items-center">
        <div className="container mx-auto px-4 max-w-6xl">
      ...
      {/* Browse by Brand */}
      <section className="py-16 bg-white border-t border-slate-200 w-full flex flex-col items-center">
        <div className="container mx-auto px-4 max-w-6xl">
